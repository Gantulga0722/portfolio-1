  ...
  return (
    <div className="flex flex-col justify-center items-center gap-[24px] sm:gap-[48px]">
      {experienceData.map((element) => (
        <div className="flex sm:w-[896px] flex-col p-[32px] items-start justify-center rounded-[12px] bg-[#FFF] shadow-[0px_2px_2px_0px rgba(0,0,0,0.06), 0px_4px_3px_0px rgba(0,0,0,0.07)]">
      ...
      {workData.map((work) =>
        work.id == "reverse" ? (
          <div className="flex flex-col sm:flex-row max-w-[1152px] rounded-[12px] shadow-md justify-center">
            <div className="flex p-[32px] justify-center items-center sefl-stretch rounded-[12px_12px_0_0] border-b border-gray-100 bg-gray-50 sm:p-[48px] sm:w-[576px] sm:h-[480px] sm:rounded-[12px_0_0_12px] sm:order-last">
              {work.image}
            </div>
