  ...
  return (
    <div className="flex p-[16px] self-stretch justify-between items-center border-b border-[rgba(255_255_255_0.00)] bg-[#FFF]">
      <div className="flex justify-between items-center flex-[1_0_0]">
        ...
        <div className="flex p-[6px] justify-center items-center rounded-[8px] relative">
          <HanburgerIcon />
        </div>
        <div className="hidden w-[375px] h-[667px] flex-col items-end shrink-0 bg-[rgba(17_24_39_0.10)] backdrop-blur-sm absolute right-0 top-0">
